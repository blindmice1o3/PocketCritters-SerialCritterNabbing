...
public class BattleBeltListActionSummary implements IState {
    ...
    public void tick(long timeElapsed) {
        ...
        if (handler.getKeyManager().keyJustPressed(KeyEvent.VK_PERIOD)) {
            System.out.println("BattleBeltListActionSummary.tick(long)... bButton");
            ...
            switch(currentPage) {
                case STATS:
                    ...
                    if (handler.getStateManager().getCurrentState() instanceof BattleState) {
                        ...
                        //pop self (BattleBeltListActionSummary).
                        stateMachine.pop();
                ...
                case MOVES:
                    ...
                    break;
                default:
                    System.out.println("BattleBeltListActionSummary.tick(long) bButton switch(currentPage) construct's default block.");
                    break;
            }
        }
        //aButton
        else if (handler.getKeyManager().keyJustPressed(KeyEvent.VK_COMMA)) {
            System.out.println("BattleBeltListActionSummary.tick(long)... aButton");
            ...
            switch(currentPage) {
                ...
                case MOVES:
                    ...
                    break;
                default:
                    System.out.println("BattleBeltListActionSummary.tick(long) aButton switch(currentPage) construct's default block.");
                    break;
            }
        }
    }
    ...
    public void render(Graphics g) {
        ...
        switch(currentPage) {
            ...
            case MOVES:
                ...
                break;
            default:
                System.out.println("BattleBeltListActionSummary.render(Graphics) switch(currentPage) construct's default block.");
                break;
        }
    }
